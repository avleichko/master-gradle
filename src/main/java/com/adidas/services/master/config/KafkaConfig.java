...
public class KafkaConfig {
    ...
    private ConsumerFactory<String, SpecificRecord> consumerFactory() {
        ...
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, "masterServiceGroup");
        properties.put(ConsumerConfig.CLIENT_ID_CONFIG, "masterService");
    ...
    private ProducerFactory<String, SpecificRecord> producerFactory() {
        ...
        properties.put(ProducerConfig.CLIENT_ID_CONFIG, "masterService");
